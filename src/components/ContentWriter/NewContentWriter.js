...
const NewContentWriter = () => {
  ...
  const handleChange = (e) => {
    ...
    } else if (name.startsWith('collaboration')) {
  ...
  <h2 className="text-2xl p-2">Add New Content Writer</h2>
  <form onSubmit={handleSubmit} className="mb-4 bg-gray-100 p-4 rounded-lg shadow-md">
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div>
        <label className="text-gray-700">Per Word Rate</label>
        <input
          type="number"
          name="collaboration.perWordRate"
      ...
      <div>
        <label className="text-gray-700">Project Rate</label>
        <input
          type="number"
          name="collaboration.projectRate"
    ...
    <div className="flex items-center justify-end space-x-2">
      ...
      <button
        disabled={!userData.permissions.contentWriter.add}
        title={!userData.permissions.contentWriter.add ? "You are not allowed to access this feature" : undefined}
        type="submit"
