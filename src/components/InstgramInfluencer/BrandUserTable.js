    ...
    <div className="p-6 lg:p-10 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 lg:gap-8">
        {currentItems.map((influencer) => (
          <div key={influencer._id} className="col-xl-3 col-lg-4 col-md-6 col-md-3">
            <div className="inflanar-influencer mg-top-30">
              <div className="inflanar-influencer__head inflanar-influencer__head--v1">
                <motion.div
